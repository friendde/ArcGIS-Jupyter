...
#%%
# Inspired by https://community.esri.com/docs/DOC-10441-downloading-feature-layer-attachments
# In Githib too https://github.com/Esri/developer-support/tree/master/python/general-python/download-attachments
